    ...
    return (
        <>
            ...
            >
                ...
                <span className="h-full flex w-[60%] items-center border-l-0 cursor-pointer border-[1px] border-[#434343] hover:underline">{props.name}</span>
                <span className="h-full flex w-[15%] items-center border-[1px] border-[#434343] justify-center">{props.mmr}</span>
            </div>
        </>
    );
};